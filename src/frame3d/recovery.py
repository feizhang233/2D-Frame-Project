...
def recover_local_end_forces(local_stiffness, local_displacements, local_equivalent_nodal_load=None):
    f = np.zeros(12) if local_equivalent_nodal_load is None else array(
        "local_equivalent_nodal_load", local_equivalent_nodal_load, (12,))
    return array("local_stiffness", local_stiffness, (12, 12)) @ array(
        "local_displacements", local_displacements, (12,)) - f


def recover_element_end_response(element, displacements, local_stiffness, transformation,
                                 local_equivalent_nodal_load=None, *, condensation=None):
    ...
    return ElementEndResponse(dg, dl, recover_local_end_forces(
        local_stiffness, dl, local_equivalent_nodal_load))
